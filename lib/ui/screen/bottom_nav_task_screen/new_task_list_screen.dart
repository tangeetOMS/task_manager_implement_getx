...
class _NewTaskListScreenState extends State<NewTaskListScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback(
          (_) {
        //_fetchAllData();
        _newTaskController.getTaskCountByStatus();
    ...
    return Scaffold(
      ...
      body: ScreenBackground(
        child: GetBuilder<NewTaskController>(builder: (controller) {
          return Visibility(
            visible: !controller.getTaskCountByStatusInProgress ||
                !controller.getNewTaskListInProgress,
                    ...
                    child: SizedBox(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          controller.taskByStatusList.sort((a, b) {
  ...
  Widget buildTasksSummaryByStatus(List<TaskCountModel> taskByStatusList) {
